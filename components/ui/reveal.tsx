...
export function Reveal({
  ...
  // Prepare children as array so we can optionally stagger individual children
  const _childArray = React.Children.toArray(children);

  // Update container variants with custom stagger delay and start delay
