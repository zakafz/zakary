...
export const work = [
    ...
    showcase: (
      <div className="w-[calc(100%-40px)] mt-5 h-full bg-accent/70 mask-[linear-gradient(180deg,#000_0%,#000_40%,transparent_100%)] mx-auto flex flex-col overflow-hidden">
        ...
        <div className="p-5 pb-0 text-xs text-justify text-muted-foreground">
          ...
          <div className="font-medium text-primary mt-3 mb-1">Heading 2</div>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non
          risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec,
    ...
    content: (
      <>
        <div className="text-muted-foreground text-justify">
          ...
          creation, management, and publishing of legal and public documents.
          Whether you're a startup needing a Privacy Policy or an enterprise
          managing complex compliance documentation, OpenPolicy provides a
          solution that is both simple and secure.
        </div>
        ...
        <ul className="list-disc list-outside space-y-2 pl-4 text-muted-foreground marker:text-primary">
          ...
          <li>
            ...
            Advanced editor with support for markdown, tables, and Excalidraw
            diagrams.
          </li>
          <li>
            <b className="text-primary font-medium">Multi-Workspace Support</b>:
            Organize documents by team, project, or client with isolated
            workspaces. (Coming soon)
          </li>
          <li>
            <b className="text-primary font-medium">Custom Domain</b>: Connect
            your own domain (e.g., docs.acme.com) with automatic SSL.
          </li>
          <li>
          ...
          <li>
            ...
            Automatic dynamic metadata generation for better discoverability.
          </li>
          <li>
        ...
        <div className="text-muted-foreground text-justify">
          ...
          wasn't bad, so I decided to build it fully. I took inspiration from{" "}
          <a
        ...
        <div className="text-muted-foreground mt-5 text-justify">
          My goal was really to work with things I never tried before, like the
          custom domain feature, which was surprisingly easy to implement. But
          then I doubled down on the production-readiness and made sure that the
          app was ready for production. And here we are! Now, I'm working on
          improving the app's performance and adding more features. Slowly but
          surely, we're making progress. And I'm excited to see where this
        ...
        <ul className="list-disc list-outside space-y-2 pl-4 text-muted-foreground marker:text-primary">
          <li>
            <b className="text-primary font-medium">Typescript</b>: Built on top
            of{" "}
            <a
          ...
          <li>
            <b className="text-primary font-medium">Rate limiting</b>: I decided
            to use{" "}
            <a
          ...
          <li>
            <b className="text-primary font-medium">Error handling</b>: My go-to
            error handling tool is{" "}
            <a
  ...
  {
    id: "localcard",
    image: "/localcard-demo-2.png",
    website: "https://shop.localcard.live/dashboard",
    showcase: (
    ...
    content: (
      <div>
        <div className="text-muted-foreground text-justify">
          Co-founded LocalCard, a digital loyalty platform that enables local
          businesses to reward and retain customers using phone numbers for easy
          rewards. Customers do not need apps or physical cards. I designed and
          launched secure, user-friendly tablet dashboards so merchants can set
          up loyalty programs without complicated POS integrations. My focus is
          to deliver simple, affordable, and effective solutions that help small
        ...
        <div className="text-muted-foreground text-justify">
          ...
          Canada. Our goal was to provide a simple, affordable, and effective
          solution that helps small businesses compete with larger chains. Our
          solution also gave businesses the chance to capture their clients
          phone numbers to then send them promotional messages (yes, everything
          was consented).
        </div>
        <Image
        ...
        <div className="text-muted-foreground text-justify">
          ...
          clients didn’t have to install a useless mobile app. Let’s be real,
          who wants to download an app at the checkout counter?
        </div>
        <div className="text-muted-foreground text-justify mt-5">
          But beyond that, I realized our pricing model wasn’t sustainable. We
          needed to conquer the whole Montréal to see meaningful revenue. So,
          slowly and sadly, we had to let go of LocalCard. We gave clients a
          30-day notice, as stated in the contract, let them export their data,
          and had to say goodbye to the theme.
        </div>
        <div className="mt-10 mb-5 font-medium">Results</div>
        <div className="text-muted-foreground text-justify">
          I believe that it was a great experience, and I learned a lot from it.
          For exemple: validate your model before getting too far or you WILL
          lose clients.
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <div className="text-muted-foreground text-justify">
          Measurely is an open-source analytics platform that makes tracking,
          analyzing, and visualizing metrics simple. With customizable metric
          types, real-time insights, and easy integrations, Measurely helps
          developers turn data into actionable insights for any project, all
          while maintaining full control over the data.
        </div>
        <div className="mt-10 mb-5 font-medium">Features</div>
        <ul className="list-disc list-outside space-y-2 pl-4 text-muted-foreground marker:text-primary">
          <li>
            <b className="text-primary font-medium">Developer-Friendly API</b>:
            Seamlessly integrate Measurely with your applications using an API
            key.
          </li>
          <li>
          ...
          <li>
            ...
            <ul className="list-disc mt-2 mb-2 list-outside space-y-2 pl-4 text-muted-foreground marker:text-primary">
              <li>
                <b className="text-primary font-medium">Basic Metrics</b>: Track
              ...
              <li>
                ...
                Add offsets or custom tracking periods for granular insights.
              </li>
            </ul>
          </li>
          <li>
        ...
        <ul className="list-disc list-outside space-y-2 pl-4 text-muted-foreground marker:text-primary">
          <li>
            <b className="text-primary font-medium">Frontend</b>: Built on top
            of{" "}
            <a
          ...
          <li>
            <b className="text-primary font-medium">Database</b>: We decided to
            use{" "}
            <a
              href="https://upstash.com"
              className="text-primary font-medium hover:underline"
          ...
          <li>
            <b className="text-primary font-medium">Payment infrastructure</b>:
            Of course, we used{" "}
            <a
        ...
        <ul className="list-disc list-outside space-y-2 pl-4 text-muted-foreground marker:text-primary">
          <li>
            <b className="text-primary font-medium">Javascript/Typescript</b>:{" "}
            <a
        ...
        <div className="text-muted-foreground text-justify mt-5">
          That’s when <b className="text-primary font-medium">Measurely</b> was
          born. We jumped straight into prototyping and building an MVP. I was
          designing in Figma while my partner handled the backend structure.
        </div>
        <div className="text-muted-foreground text-justify mt-5">
          After a couple months of hard work, we had an MVP we were proud of and
          opened a waitlist. The thing is, during that time we had school :(
          Most days we couldn’t dedicate enough time to the project. We decided
          to take a break and focus on our studies. Unfortunately, we couldn’t
          keep pushing Measurely because of our schedules.
        </div>
        <div className="text-muted-foreground text-justify mt-5">
          Since then, I told myself I’d never put school over my projects, and
          it worked. I kept grinding on other projects, sharpening my skills in
          frontend development.
        </div>
        <div className="text-muted-foreground text-justify mt-5">
          Maybe one day I’ll start working on Measurely again.{" "}
          <b className="text-primary font-medium">Who knows?</b> For now, I’ve
          got other projects to build.
        </div>
      </div>
    ),
  },
